...
class LessonResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\TimePicker::make('start_time')->label('Boshlanish')->seconds(false)->native(false)->required(),
            Forms\Components\TimePicker::make('end_time')->label('Tugash')->seconds(false)->native(false)->required(),
